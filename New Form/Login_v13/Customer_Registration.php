...
<style>
body {font-family: Arial, Helvetica, sans-serif; background-image: url("images/Food 2.jpg"); padding-left: 840px; background-size: 1000px 1320px; background-repeat:repeat;}
</style>
		...
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="Customer_Registration2.php" method="POST">
					...
					<div class="form-check-inline">
						<span class="label-input100">Nation:</span> <br><br>
						<div class="form-check-inline">
						<label class="label-input100"><span class="radiotextsty">Sinhala</span>
						  <input type="radio" name="radio2" value="2">
						  <span class="checkmark"></span></label> 
					<label class="label-input100"><span class="radiotextsty">Tamil</span>
					  <input type="radio" name="radio2" value="2">
					  <span class="checkmark"></span></label>
						<label class="label-input100"><span class="radiotextsty">Muslim</span>
						  <input type="radio" name="radio2" value="2">
						  <span class="checkmark"></span></label>
