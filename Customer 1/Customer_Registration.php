...
<!--	<div class="limiter" style="padding-left: 840px;">  -->
	<div class="split right">
		<div class="container-login100">
			<section id="nav-bar" style="padding-left: 75px; background-color: white;">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="Customer_Registration.php" method="POST">
				...
				<div class="form-check-inline">
				<label class="label-input100"><span class="radiotextsty" style="margin-left:30px">Vegeterian</span>
					<input type="radio" id="veg"  name="veg" value="1" checked >
					<span class="checkmark" style="margin-left:30px"></span>     
				<label class="label-input100"><span class="radiotextsty">Non-Vegeterian</span></label>
					<input type="radio" name="veg" value="2">
					<span class="checkmark"></span></label>
        <br> <br>
				</div>
...
<!--							<button class="login100-form-btn" onClick="ValidateForm(this.form)"> -->
							<button class="login100-form-btn" id="register"> Sign Up </button>
		...
		$('#register').click(function(e){
			...
			var password = $('#password').val();
				...
				$.ajax({
					...
					data: {username: username,lastname: lastname,age: age,nation: nation,veg: veg,ptype: ptype,ftimes: ftimes,address: address,email: email,password: password},
