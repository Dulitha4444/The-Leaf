<?php
	...
	try{
		...
		$link = new \PDO(   'mysql:host=localhost;dbname=leaf;charset=utf8mb4', //'mysql:host=localhost;dbname=canvasjs_db;charset=utf8mb4',
                        'root', //'root',
                        '', //'',
                        array(
		...
		$handle = $link->prepare('Select MONTHNAME(recive_date) AS a, COUNT(user_id) AS b from customer_registration Group By Month(recive_date)');
		$handle->execute();
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="adminpanel.php">The Leaf</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Manage Item">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseItems" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Manage Offers & Discounts</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseItems">
            <li>
              <a href="testimg.php">Offers</a>
              <a href="testimg.php">Discounts</a>
            </li>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Registered Customers">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseUsers" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Registered Customer</span>
          </a>
              ...
              <a href="Customer.html">All Customers</a>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Request for Quotations">
		          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseQuotations" data-parent="#exampleAccordion">
		            ...
		            <span class="nav-link-text">Registered Shops</span>
		          </a>
		          <ul class="sidenav-second-level collapse" id="collapseQuotations">
		            <li>
		              <a href="customer.html">All Shops</a>
		            </li>
		...
		<div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Discounts & Offers</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="testimg.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fa fa-angle-right"></i>
                </span>
		...
		<div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-dark o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Shops</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="shop.html">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fa fa-angle-right"></i>
                </span>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyrights &copy; 2019 All Rights Reserved by The Leaf Inc</small>
        </div>
      </div>
    </footer>
